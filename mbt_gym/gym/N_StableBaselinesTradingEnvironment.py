...
from mbt_gym.gym.N_Bek_TradingEnvironment import Bek_TradingEnvironment  # import multi-asset environment

class StableBaselinesTradingEnvironment(VecEnv):
    def __init__(
        self,
        trading_env: Bek_TradingEnvironment,  # accepts multi-asset Bek_TradingEnvironment
        ...
        # Ensure VecEnv receives correct shapes for multi-asset env
    ...
    def set_attr(self, attr_name: str, value: Any, indices: VecEnvIndices = None) -> None:
        pass  # leave unchanged — no behavior change unless needed
